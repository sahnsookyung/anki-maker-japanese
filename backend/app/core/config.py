...
OCR_CROP_CONFIRM_MAX_FIELDS = int(os.getenv("OCR_CROP_CONFIRM_MAX_FIELDS", "3"))
OCR_RECOVERY_MAX_FIELDS = int(os.getenv("OCR_RECOVERY_MAX_FIELDS", "8"))
OCR_RECOVERY_MAX_REGIONS = int(os.getenv("OCR_RECOVERY_MAX_REGIONS", "4"))
OCR_RECOVERY_MAX_PREPROCESSORS = int(os.getenv("OCR_RECOVERY_MAX_PREPROCESSORS", "3"))
...
PADDLE_OCR_USE_LANGUAGE_PROFILE = os.getenv("PADDLE_OCR_USE_LANGUAGE_PROFILE", "false").lower() in {
    "1",
    "true",
    "yes",
    "on",
...
PADDLE_OCR_KOREAN_LANG = os.getenv("PADDLE_OCR_KOREAN_LANG", "").strip()
PADDLE_OCR_KOREAN_USE_LANGUAGE_PROFILE = os.getenv(
